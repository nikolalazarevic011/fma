        ...
        <Popover className="relative">
          {({ open, close }) => (
            <>
              ...
              >
                <Popover.Panel className="absolute right-0 z-50 w-56 mt-3 transform">
                  <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="relative bg-white">
                      ...
                      <a
                        className="flex items-center p-4 text-base font-medium cursor-pointer text-primary hover:bg-gray-50 hover:text-menuHighlightBlue"
                        onClick={() => {
                          handleLogout();
                          close();
                        }}
